...
- La barra de pestañas inferior y `activeTab` están en `App.tsx`; no hay `@react-navigation` ni `TabNavigator`. Perfil no es pestaña inferior: se abre con ⚙️ en Inicio (`activeTab` `'perfil'`).
